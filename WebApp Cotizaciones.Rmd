...
library(pacman)
pacman::p_load(terra, sf, fs, hablar, gcookbook, plotly, extrafont,
               RColorBrewer, rmapshaper, readxl, glue, hrbrthemes,
               tidyverse, leaflet, htmltools, leaflet.extras, DT,
               paletteer, packcircles, viridis, ggiraph, googlesheets4)
```
...
BD<-read_sheet("https://docs.google.com/spreadsheets/d/1OAt-gy14M2DsW533DC7yI1H13Onvo-iXS6RGvXG8YK4/edit#gid=969329261",
               sheet = "INTERNO", range= "INTERNO!A2:DZ")

BD2<-read_sheet("https://docs.google.com/spreadsheets/d/1OAt-gy14M2DsW533DC7yI1H13Onvo-iXS6RGvXG8YK4/edit#gid=969329261",
                sheet = "EXTERNO", range= "EXTERNO!A2:BP")
...
ggplot(`Solicitudes por materia`, aes(x="", y=n, fill=Materia)) +
  ...
  coord_polar("y", start=0)+
   theme_void()+
  scale_fill_manual(values = paletteer_dynamic("cartography::pastel.pal", 19))
